...
public class ConnectionPool {
    ...
    public ConnectionPool()
    {
        ...
        int poolSize = Integer.parseInt(properties.getProperty(DB_POOLSIZE, "5"));
        ...
        try {
            ...
            throw new ConnectionPoolException("SQLException in ConnectionPool.ConnectionPool", e);
        }
    }
    ...
    public void close() throws SQLException
    {
        ...
        {
            throw new SQLException("Error deleting connection from the gien away connection pool.");
        }
